...
#define RECEIVE_DATA_SIZE		28//下位机发过来的数据的长度
...
class turn_on_robot
{
	...
	private:
		...
		ros::Publisher odom_publisher, imu_publisher, voltage_publisher,hcsr04_scan_publisher;//初始化3个发布者
...
/*********************new***************************/
		...
		int num_readings ;
		double sonar_laser_frequency ;
		float rangemax,rangemin;
		float hc_sr04_distance_f;
};
#endif
